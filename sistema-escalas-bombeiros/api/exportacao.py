...
def gerar_xlsx(
    ...
    ws["A2"] = f"Escalas BM · Corpo de Bombeiros · versão {versao} · {status}"
...
<p class="sub">Escalas BM &nbsp;·&nbsp; Corpo de Bombeiros &nbsp;·&nbsp; versão {versao} &nbsp;·&nbsp; {status}</p>
<table>
...
def _pdf_reportlab(
    ...
    elementos = [
        ...
        Paragraph(
            f"Escalas BM &nbsp;·&nbsp; Corpo de Bombeiros &nbsp;·&nbsp; "
