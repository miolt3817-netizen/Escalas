...
class Usuario(Base):
    ...
    #: Como a pessoa é chamada no quartel: "Sd. Sfredo", "Cabo Rocha".
    #: O nome completo não cabe na célula do calendário e ninguém usa na rotina.
    nome_curto: Mapped[str] = mapped_column(String(40), default="", server_default="")
    #: Para o supervisor ligar direto de dentro do sistema quando precisa de
    #: substituto às 6h da manhã.
    telefone: Mapped[str] = mapped_column(String(20), default="", server_default="")
    #: Como a pessoa é chamada no quartel ("Sd. Sfredo", "Cabo Rocha"). Nome
    #: completo ocupa três linhas na célula do calendário e atrapalha bater o
    #: olho. Vazio significa "derive do nome completo".
    nome_curto: Mapped[str] = mapped_column(String(40), default="", server_default="")
    #: Para o supervisor ligar quando precisa de substituto às 6h da manhã.
    #: Sem isso o sistema resolve o difícil e para antes do fácil.
    telefone: Mapped[str] = mapped_column(String(25), default="", server_default="")
