...
def test_arquivos_do_pwa_sao_servidos(servidor_web):
    ...
    for rota, tipo in [
        ...
        ("/estatico/icone-192.png", "image/png"),
        ("/estatico/icone-512.png", "image/png"),
        ("/estatico/icone-apple.png", "image/png"),
    ]:
